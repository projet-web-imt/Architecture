<?php
        ...
        class View extends MyObject {
            ...
            public function __construct($controller,$templateName) {
                ...
                if ($request-> getController() == 'user'){$this->templateNames['top'] = 'topUser';}
                else {$this->templateNames['top'] = 'top';}
            ...
            public function render() {
                ...
                $this->loadTemplate($this->templateNames['top']);
                $this->loadTemplate($this->templateNames['menu']);
